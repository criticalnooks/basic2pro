            ...
            <div class="row">
                <div class="main-slider">
                    <div class="slide-text">
                        <span class="font-head">Basic to Programming</span><br><br><br><br>
                        <span class="font-content2">     ยินดีต้อนรับสู่เว็บไซต์ B2P หรือ Basics to Programming เว็บไซต์ที่รวบรวมเนื้อหา แบบฝึกหัด ขั้นพื้นฐานต่างๆเกี่ยวกับการเขียนโปรแกรมเบื้องต้นเกี่ยวกับภาษา C</span>
...
<script type='text/javascript' src='http://www.siamecohost.com/member/gcounter/graphcount.php?page=onestone.eng.src.ku.ac.th:9000&style=54'></script>
</div>
    </footer>
    <!--/#footer-->
