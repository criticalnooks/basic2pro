            ...
            <div class="container">
                <div class="row">
                    ...
                    <span style="font-family: 'Kanit';font-size:27px">► </span>
                      <a href="/forums/board1"><span style="font-family:Kanit;font-size:27px"> Announcement  </span></a> <br><br>

                        @if (Auth::id() == 1)                                                    
                                <a href="/forums/board1/post"> <button  type="submit" class="btn btn-default btn-lg" aria-label="Left Align">
                                    ...
                                    <div class="modal-body">  
                                        <div class="box">
                                            <div class="content">
                                                ...
                                                <div class="error"></div> 
                                                <div class="form loginBox">
                                                    <form method="post" action="/forums/board1" accept-charset="UTF-8">
                                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
