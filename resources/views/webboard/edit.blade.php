                ...
                <div class="row">
                    <div class="portfolio-items">
                           ...
                           <a href="javascript:history.back()"><span style="font-family: 'Kanit';font-size:27px">{{ $thread->thread_name }}  </span></a>
                            <span style="font-family:Kanit;font-size:27px">►  </span>
                            <a href="javascript:window.location.href=window.location.href"><span style="font-family:Kanit;font-size:27px">Edit  </span></a> <br><br>

               
                       
                        <!-- Default panel contents -->                                                      
                            <form action="{{ url('/forums/boardcontent/edit',$thread->thread_id) }}" method="post">
                                <nav class="navbar navbar-default" style="padding: 2%">
                                
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}"> 
                                    <input type="hidden" name="_method" value="put">
                                    <input type="hidden" name="thread_id" value="{{ $thread->thread_id }}">   
                                    <textarea autofocus class="form-control font-content2" style="height: 200px"  name="content" maxlength="2000">{{ $thread->thread_content }}</textarea>
