            ...
            <div class="container">
                <div class="row">
                    <div class="portfolio-items">
                           ...
                           <a href="javascript:history.back()"><span style="font-family: 'Kanit';font-size:27px">{{ $thread->thread_name }}  </span></a>
                            <span style="font-family:Kanit;font-size:27px">►  </span>
                            <a href="javascript:window.location.href=window.location.href"><span style="font-family:Kanit;font-size:27px">Edit Comment </span></a> <br><br>

                     
      
              
                        <!-- Default panel contents -->                                                      
                             <form action="{{ url('/forums/boardcontent/edit2',$comment->comment_id) }}" method="post">
                                <nav class="navbar navbar-default" style="padding: 2%">
                                <div>
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}"> 
                                    <input type="hidden" name="_method" value="put">
                                    <input type="hidden" name="thread_id" value="{{ $thread->thread_id }}">   
                                    <textarea class="form-control font-content2" style="height: 200px"  name="content" maxlength="2000">{{ $comment->comment_content }}</textarea>
                                </div>
                                    <button class="btn btn-default" aria-label="Left Align" style="margin-top: 1%">
                                        <span aria-hidden="true" style="font-family: 'Kanit'"><img src="{{ asset('images/comment.png') }}">Edit</span>
                                    </button>
                                </nav>
                            </form>
