            ...
            <div class="container">
                <div class="row">
                    ...
                    <span style="font-family: 'Kanit';font-size:27px">► </span>
                            ...
                            <a href="/forums/board2"><span style="font-family:Kanit;font-size:24px">Programming Talk  </span></a> 
                            <span style="font-family:Kanit;font-size:24px">►  </span>
                            <a href="javascript:window.location.href=window.location.href"><span style="font-family:Kanit;font-size:24px">POST  </span></a> <br><br>
                            ...
                            <form action="/forums/board2/post" method="post">
                                <nav class="navbar navbar-default" style="padding: 2%">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-addon font-content2" id="sizing-addon1">หัวข้อ</span>
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">       
                                        <input type="text" name="name" class="form-control font-content2" placeholder="หัวข้อ" aria-describedby="sizing-addon1" autocomplete=off maxlength="50">
                                    </div>
                                    <div>
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">       
                                        <textarea class="form-control font-content2" name="content"  style="height: 200px"  placeholder="Enter text here..." maxlength="2000"></textarea>
                                    </div>
                                    <button type="submit" class="btn btn-default" aria-label="Left Align" style="margin-top: 1%">
                                        <span aria-hidden="true" style="font-family: 'Kanit'"><img src="{{ asset('images/post.png') }}">
                                        Post</span>
                                    </button>
                                </nav>
                            </form>
